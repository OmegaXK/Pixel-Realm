...
def main():
    ...
    app.setApplicationName("Mine Crack")
    app.setOrganizationName("Crack OS")
    app.setOrganizationDomain("scratch.com")
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.browser.setUrl(QUrl("https://scratch.mit.edu/projects/10128407/"))
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Mine Crack", self)
        about_action.setStatusTip("Find out more about Mine Crack")
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Crack Tube" % title)
