...
def main():
    ...
    app.setOrganizationDomain("cgptonline.tech")
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.browser.setUrl(QUrl("https://cgptonline.tech/chat-gpt-online/"))
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Crack AI", self)
        about_action.setStatusTip("Find out more about Crack AI")
